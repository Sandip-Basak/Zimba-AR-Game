...
export const SNACK_TYPES: Omit<Snack, 'id' | 'x' | 'y' >[] = [
  ...
  { type: 'rare', points: 50, imageUrl: '/game-assets/products/tiger.png', imageHint: 'Company Rare Treat', width: 170, height: 170 },
  ...
  { type: 'premium', points: 10, imageUrl: '/game-assets/products/product-5.png', imageHint: 'Company Treat', width: 90, height: 90 },
